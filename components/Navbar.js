...
import { getLatestCompletedProblems, logOut, useAuth } from "../lib/hooks";
          ...
          <Flex align="center" justify="space-between" wrap="wrap">
            ...
            <Flex align="center" flexGrow={1} justify="center">
              <div>
                ...
                <NavLink
                  href="https://github.com/nandrehetan"
                  isExternal
                >
              ...
              <Flex align="center">
                ...
                >
                  <VscGithub title="GitHub" size={21} />
                </Button>
                {/* <Button
                  ml={2}
                  size={isMobile ? "xs" : "sm"}
                  colorScheme="whiteAlpha"
                  onClick={() =>
                    open("https://github.com/bhaveshpatil07", "_blank")
                  }
                >
                  Main Website
                </Button> */}
                {isLoggedIn ? (
                  <Button onClick={() => { logOut(); }} ml={2} size={isMobile ? "xs" : "sm"} colorScheme="whiteAlpha">
                    Log Out
                  </Button>
                ) :
                  (
